...
<body class="flex items-center mx-24 justify-center min-h-screen bg-gray-800">
    <div class="bg-gray-600 p-8 px-12 rounded-lg shadow-lg w-full max-w-sm gap-8 flex flex-col items-center justify-center text-white">
        ...
        <form action="index.php?action=register" method="POST" class="space-y-4">
            ...
            <input type="text" id="email" name="email" placeholder="Enter your email" class="w-full text-black bg-gray-300 border border-gray-400 p-2 px-4 rounded-lg mb-4" required>
        ...
        <p>Already have an account? <a href="index.php?action=login" class="text-blue-300 hover:text-blue-500 underline">Login here</a></p>
    </div>
</body>
